...
select salary/30 as 'DAILY SAL OF JONES' from tblEMP where ename = 'JONES';

--______________________________________________________________________________________

8. Calculate the total monthly salary of all employees. 
select sum(salary) as 'TOTAL MONTHLY SAL OF ALL EMP' from tblEMP;

--______________________________________________________________________________________

9. Print the average annual salary . 
select AVG(salary*12) as 'AVG ANNUAL SALARY' from tblEMP;
